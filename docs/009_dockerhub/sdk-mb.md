...
------------------------------------
SDK Message broker docker image is part of the IIH SDK suite of applications. It is a Mosquitto MQTT broker application with some modifications to act as a bridge between the IIH Essentials Simulator and Databus.
